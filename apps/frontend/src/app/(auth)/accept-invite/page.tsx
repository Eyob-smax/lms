        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              {email ? (
                <>Welcome! Create a secure password for <strong className="text-slate-200">{email}</strong> to activate your LMS access.</>
              ) : (
                'Welcome! Create a secure password to activate your LMS access and get started.'
              )}
            </p>
          </div>
          ...
          {success && (
            <div className="mb-6 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-start gap-3 text-emerald-400 text-sm">
              ...
              <div>
                ...
                <p className="text-xs text-emerald-300 mt-1">Redirecting to your platform dashboard...</p>
              </div>
            </div>
          )}
      ...
      <div className="hidden lg:flex relative overflow-hidden bg-gradient-to-br from-indigo-900/40 via-[#0b0f19] to-slate-900 items-center justify-center p-12 border-l border-slate-800/80">
        ...
        <div className="max-w-lg relative z-10 space-y-8">
          ...
          <h2 className="text-4xl font-extrabold text-white tracking-tight leading-tight">
            Welcome to Your Enterprise Learning Hub
          </h2>

          <p className="text-slate-400 text-base leading-relaxed">
            Activate your account to access dynamic AI-generated courses, real-time quizzes, personalized cohorts, and comprehensive training dashboards.
          </p>
          ...
          <div className="grid grid-cols-2 gap-4 pt-4">
            <div className="p-4 rounded-2xl bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm">
              ...
              <p className="text-slate-400 text-xs leading-relaxed">Token-secured invitations with JWT authentication.</p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm">
              ...
              <h3 className="text-white font-bold text-sm mb-1">AI-Assisted Learning</h3>
              <p className="text-slate-400 text-xs leading-relaxed">Next-generation markdown courses and automated quizzes.</p>
            </div>
          </div>
        </div>
      </div>
...
export default function AcceptInvitePage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0b0f19] flex items-center justify-center text-white text-sm">Loading activation page...</div>}>
      <AcceptInviteContent />
    </Suspense>
  );
}
